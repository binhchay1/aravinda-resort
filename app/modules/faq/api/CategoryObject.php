...
class CategoryObject extends \yii\easyii\components\CategoryApiObject
{
    ...
    public function parents(){
        if(!$this->_parents){
            $this->_parents = \app\modules\faq\models\Category::findOne(['category_id' => $this->id])->parents()->all();
        }
    ...
    public function children(){
        if(!$this->_children){
            $this->_children = \app\modules\faq\models\Category::findOne(['category_id' => $this->id])->children()->all();
        }
