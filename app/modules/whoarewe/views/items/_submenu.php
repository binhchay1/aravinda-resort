...
<ul class="nav nav-tabs">
    ...
    <li <?= ($action === 'photos-mobile') ? 'class="active"' : '' ?>><a href="<?= Url::to(['/admin/'.$module.'/items/photos-mobile', 'id' => $model->primaryKey]) ?>"><span class="glyphicon glyphicon-camera"></span> Photos Mobile</a>
