...
use app\modules\tours\models\Item;
...
class ItemsController extends Controller
{
            ...
            if(Yii::$app->request->isAjax){
                ...
                if (isset($_FILES) && $this->module->settings['itemThumb']) {
                    ...
                    if ($model->image && $model->validate(['image'])) {
                        $model->image = Image::upload($model->image, 'tours');
                    } else {
                        $model->image = '';
                    }
                }
                if ($model->save()) {
                    $this->flash('success', Yii::t('easyii/tours', 'Item created'));
    ...
    public function actionEdit($id)
    {
        ...
        if ($model->load(Yii::$app->request->post())) {
            if(Yii::$app->request->isAjax){
                ...
                if ($model->save()) {
                    $this->flash('success', Yii::t('easyii/tours', 'Item updated'));
                    return $this->redirect(['/admin/'.$this->module->id.'/items/edit', 'id' => $model->primaryKey]);
                } else {
    ...
    public function actionDelete($id)
    {
        ...
        return $this->formatResponse(Yii::t('easyii/tours', 'Item deleted'));
    }
