...
class Item extends \navatech\language\db\ActiveRecord
{
    ...
    public function behaviors()
    {
        ...
        $behaviors['seoBehavior'] = SeoBehavior::className();
        $behaviors['ml'] = [
            ...
            'translateClassName' => '\app\modules\programmes\models\ItemLang',
            'translateTableName' => 'app_programmes_items_translate',
            'translateForeignKey' => 'item_id'
        ];
        return $behaviors;
    }
    ...
    {
        // if (parent::beforeSave($insert) || 1==1) {
